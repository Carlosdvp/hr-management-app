...
<template>
  <div 
    class="cursor-pointer w-[40px] h-[50px] bg-slate-800 py-3 pl-2"
    @click="toggleSideBar">
  ...
  <div class="sm:w-[100px] md:w-[200px] h-full bg-slate-200 text-white" :class="{ 'hidden': !showSide }">
    <div class="h-[50px] bg-slate-800 flex items-center justify-center">
      <h3 class="font-bold sm:text-base md:text-xl">Dashboard</h3>
    </div>
