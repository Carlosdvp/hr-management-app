<template>
  <div class="flex w-screen h-screen">
    <div class="w-[200px] h-full bg-slate-200 text-white">
      ...
      <div class="h-[calc(100vh-50px)] bg-slate-600">
        <div class="flex flex-col justify-between h-full px-[20px] space-y-[10px]">
          <div class=" flex flex-col justify-between space-y-[10px]">
            ...
            <router-link to="/profile-page" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-medium rounded-md border-gray-200 hover:bg-gray-300  hover:text-gray-800 transition duration-400 ease-in-out">
              <svg aria-hidden="true" class="mr-2 w-[25px] h-[25px] fill-current" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="w-full h-full">
      <div class="h-[50px] bg-slate-800"></div>
      <div class="h-[calc(100vh-50px)] bg-slate-300">
        main
      </div>
    </div>
  </div>
